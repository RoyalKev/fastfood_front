      ...
      <div className="dashboard-tlbar d-block mb-4">
        <div className="row">
          <div className="colxl-12 col-lg-12 col-md-12">
            <h1 className="mb-1 fs-3 fw-medium">Boutiques</h1>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                <li className="breadcrumb-item"><a href="#" className="text-primary">Liste des boutiques</a></li>
              </ol>
            </nav>
          </div>
        </div>
          ...
          <div className="col-xl-12 col-lg-12 col-md-12 col-12">
            <div className="dashboard-search-wrap">
              ...
              <div className="showingOption">
                ...
                <div className="search-field d-flex align-items-center justify-content-start gap-2">
                  ...
                  <div className="frm-search">
                    <div className="form-group formField icons right mb-0">
                      <input type="text" className="form-control" placeholder="Entrez le nom de la boutique"/>
                ...
                <div class="">
                                        <a href="/NouveauBoutique" class="btn btn-primary btn-md">
