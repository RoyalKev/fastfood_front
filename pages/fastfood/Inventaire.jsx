...
const Inventaire = () => {
    ...
    const fetchinventaire = async (page = 1) => {
        try {
            const response = await axios.get(`${StaticIP}api/inventaire/liste?page=${page}&limit=5`);
            if (response.data.Status) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${StaticIP}api/inventaire/nouveau`, {
                inventaireData,
    ...
    const handleShowinventaire = (id) => {
        ...
        axios.get(`${StaticIP}api/inventaire/lignes/` + id)
            .then(result => {
    ...
    const handleCancelinventaire = async (inventaireId) => {
        ...
        try {
            const response = await axios.put(`${StaticIP}api/inventaire/annuler/${inventaireId}`);
            if (response.data.success) {
