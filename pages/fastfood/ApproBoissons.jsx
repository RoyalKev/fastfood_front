...
const ApproBoissons = () => {
    ...
    const fetchappro = async (page = 1) => {
        try {
            const response = await axios.get(`${StaticIP}api/approboisson/liste?page=${page}&limit=5`);
            if (response.data.Status) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${StaticIP}api/approboisson/nouveau`, {
                approData,
    ...
    const handleShowappro = (id) => {
        ...
        axios.get(`${StaticIP}api/approboisson/lignes/` + id)
            .then(result => {
    ...
    const handleCancelAppro = async (approId) => {
        ...
        try {
            const response = await axios.put(`${StaticIP}api/approboisson/annuler/${approId}`);
            if (response.data.success) {
