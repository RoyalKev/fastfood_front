...
const Utilisateur = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('direction_id', dataUtilisateur.direction_id);
                                ...
                                <div className="row g-3 align-items-center">
                                    ...
                                    <div className="col-md-12">
                                            ...
                                            <select class="form-control"
                                                name="direction_id"
                                                onChange={(e) => setDataUtilisateur({ ...dataUtilisateur, direction_id: e.target.value })}
                                            >
                                                <option value=""> Sélectionner</option>
                                                {directions.map((direction, index) => (
                                                    <option value={direction.id} key={direction.id}> {direction.nom_direction}</option>
                                                ))}
                                            </select>
                                        </div>
                                    <div className="col-md-12">
