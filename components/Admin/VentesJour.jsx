...
const VentesJour = () => {
  ...
  useEffect(() => {
    axios.get(`${StaticIP}api/vente/ventes-par-jour`)
      .then(response => {
      ...
      <table className="w-full border-collapse border border-gray-200">
        ...
        <tfoot>
          <tr className="bg-gray-200 font-bold">
            <td className="border p-2 text-right" colSpan="2">Montant Total :</td>
            <td className="border p-2 text-center">{montantGlobal.toLocaleString()}</td>
          </tr>
        </tfoot>
      </table>
    </div>
